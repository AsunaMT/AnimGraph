...
namespace AnimGraph.Editor
{
    ...
    {
        private readonly Node_StateMachine _graphAsset;

        private bool _active;

        private EditorNode_SM_NodeBase _fromNode;
        ...
        public StateTransitionEdgeConnector(Node_StateMachine graphAsset)
        {
